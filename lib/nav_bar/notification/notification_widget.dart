...
class _NotificationWidgetState extends State<NotificationWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      await actions.updateNotificationToSeen(
    ...
    return StreamBuilder<List<NotificationRecord>>(
      stream: queryNotificationRecord(
        queryBuilder: (notificationRecord) =>
            notificationRecord.orderBy('created_time', descending: true),
      ),
                  ...
                  Expanded(
                    child: Builder(
                      builder: (context) {
                            ...
                            builder: (context) {
                              final allNotification =
                                  notificationNotificationRecordList
                                      .where((e) =>
                                          e.userTypeOfReceiver == 'Super Admin')
                                      .toList();
                              ...
                              return SingleChildScrollView(
                                child: Column(
                                  mainAxisSize: MainAxisSize.max,
                                  children:
                                      List.generate(allNotification.length,
                                          (allNotificationIndex) {
                                    final allNotificationItem =
                                        allNotification[allNotificationIndex];
                                    return Column(
                                      mainAxisSize: MainAxisSize.max,
                                      children: [
                                        Container(
                                          decoration: BoxDecoration(
                                            color: allNotificationItem.seen ==
                                                    true
                          ...
                          return Builder(
                            builder: (context) {
                              final allNotification =
                                  notificationNotificationRecordList
                                      .where((e) =>
                                          e.userTypeOfReceiver == 'Brgy. Admin')
                                      .toList();
                        ...
                        } else if (FFAppState().switchTo == 'Business') {
                          return Builder(
                            builder: (context) {
                              final allNotification =
                                  notificationNotificationRecordList
