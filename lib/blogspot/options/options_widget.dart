  ...
  Widget build(BuildContext context) {
    return StreamBuilder<BlogspotRecord>(
      ...
      builder: (context, snapshot) {
        ...
        final createNoteBlogspotRecord = snapshot.data!;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  if ((createNoteBlogspotRecord.isDeleted != true) &&
                      (createNoteBlogspotRecord.isArchived != true))
                    Padding(
                      padding:
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          await createNoteBlogspotRecord.reference.update({
                            ...
                            ...mapToFirestore(
                              {
                                'date_archived': FieldValue.serverTimestamp(),
                              },
                            ),
                          });
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              ...
                              backgroundColor: Color(0xFF6579EA),
                            ),
                          );
                        },
                        child: Container(
                      ...
                      child: InkWell(
                        ...
                        onTap: () async {
                          ...
                          await createNoteBlogspotRecord.reference.update({
                            ...createBlogspotRecordData(
                              ...
                              deletedBy:
                                  '${valueOrDefault(currentUserDocument?.userType, '')} - ${valueOrDefault(currentUserDocument?.firstName, '')} ${valueOrDefault(currentUserDocument?.lastName, '')}',
                              permanentlyDeleteOn:
                                  functions.permanentlyDeleteOnThisDate(
                                      getCurrentTimestamp),
                              isArchived: false,
                            ),
                            ...mapToFirestore(
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              content: Text(
                                'This post is now on Trash and will be deleted in 30 days.',
                                style: TextStyle(
                                  color: FlutterFlowTheme.of(context)
                                      .primaryBackground,
                                ),
                    ...
                    InkWell(
                      ...
                      onTap: () async {
                        ...
                        if (confirmDialogResponse) {
                          context.goNamed(BlogspotWidget.routeName);

                          await createNoteBlogspotRecord.reference.delete();
                        }
                      },
                      child: Container(
                        width: double.infinity,
