...
import 'edit_truck_details_model.dart';
export 'edit_truck_details_model.dart';

class EditTruckDetailsWidget extends StatefulWidget {
  const EditTruckDetailsWidget({
    super.key,
  ...
  @override
  State<EditTruckDetailsWidget> createState() => _EditTruckDetailsWidgetState();
}

class _EditTruckDetailsWidgetState extends State<EditTruckDetailsWidget>
    with TickerProviderStateMixin {
  late EditTruckDetailsModel _model;
                        ...
                        children: [
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller: _model.plateNumberTextController ??=
                                  ...
                                  text: card8TrucksRecord?.plateNumber,
                                ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                controller:
                                    _model.chasisNumberTextController ??=
                                        TextEditingController(
                                  text: card8TrucksRecord?.chasisNumber,
                                ),
                                focusNode: _model.chasisNumberFocusNode,
                                autofocus: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                ...
                                textAlign: TextAlign.start,
                                validator: _model
                                    .chasisNumberTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          ...
                          Align(
                            ...
                            child: Padding(
                              ...
                              child: TextFormField(
                                ...
                                textAlign: TextAlign.start,
                                validator: _model.brandTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 10.0),
                              child: TextFormField(
                                controller: _model.fuelTextController ??=
                                    TextEditingController(
                                  text: card8TrucksRecord?.fuel,
                                ),
                                focusNode: _model.fuelFocusNode,
                                autofocus: true,
                                obscureText: false,
                                decoration: InputDecoration(
                                  labelText: 'Fuel',
                                ...
                                textAlign: TextAlign.start,
                                validator: _model.fuelTextControllerValidator
                                    .asValidator(context),
                              ),
                            ),
                          ),
                                      ...
                                      onTap: () async {
                                        ...
                                        if (confirmDialogResponse) {
                                          await card8TrucksRecord!.reference
                                            ...
                                            fuel:
                                                _model.fuelTextController.text,
                                            type:
