...
import 'add_new_truck_model.dart';
export 'add_new_truck_model.dart';

class AddNewTruckWidget extends StatefulWidget {
  const AddNewTruckWidget({super.key});

  @override
  State<AddNewTruckWidget> createState() => _AddNewTruckWidgetState();
}

class _AddNewTruckWidgetState extends State<AddNewTruckWidget>
    with TickerProviderStateMixin {
  late AddNewTruckModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddNewTruckModel());
    ...
    _model.chasisNumberTextController ??= TextEditingController();
    ...
    _model.fuelTextController ??= TextEditingController();
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsetsDirectional.fromSTEB(
                              0.0, 0.0, 0.0, 10.0),
                          child: TextFormField(
                            controller: _model.chasisNumberTextController,
                                    ...
                                    onTap: () async {
                                      var confirmDialogResponse =
                                          await showDialog<bool>(
                                              ...
                                              false;
                                      if (confirmDialogResponse) {
                                        if ((_model.plateNumberTextController.text != '') &&
                                            (_model
                                                        .fuelTextController.text !=
                                                    '') &&
                                            (_model
                                            ...
                                            (_model.brandTextController
                                                        .text !=
                                                    '')) {
                                          await TrucksRecord.collection
                                              .doc()
                                              .set({
                                            ...createTrucksRecordData(
                                              plateNumber: _model
                                                  .plateNumberTextController
                                                  .text,
                                              chasisNumber: _model
