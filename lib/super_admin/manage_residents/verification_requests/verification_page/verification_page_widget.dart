                                            ...
                                            child: Padding(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  Text(
                                                    valueOrDefault<String>(
                                                      '${columnUserRecord?.houseNoStreet}, ${columnUserRecord?.barangay}, Baliwag, Bulacan',
                                                      'N/A',
                                                    ),
                                                    style: FlutterFlowTheme.of(
                                                            context)
                            ...
                            onTap: () async {
                              ...
                              await NotificationRecord.collection.doc().set({
                                ...createNotificationRecordData(
                                  ...
                                  message:
                                      'Barangay Admin Declined your Verification Request',
                                  receiver: columnUserRecord.reference,
                                ),
                                ...mapToFirestore(
                                  {
                                    'created_time':
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '${columnUserRecord.firstName} ${columnUserRecord.lastName}\'s account has been rejected.',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryBackground,
                                    ),
                          ...
                          InkWell(
                            ...
                            onTap: () async {
                              ...
                              await NotificationRecord.collection.doc().set({
                                ...createNotificationRecordData(
                                  image:
                                      'https://firebasestorage.googleapis.com/v0/b/ecommunity-awspik.appspot.com/o/profile_verification.png?alt=media&token=b9fb19c7-ea5e-4c76-bd19-5fb444edc132',
                                  message:
                                      'Barangay Admin Approved your Verification Request',
                                  receiver: columnUserRecord.reference,
                                ),
                                ...mapToFirestore(
                                  {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    '${columnUserRecord.firstName} ${columnUserRecord.lastName}\'s account has been verified.',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryBackground,
                                    ),
