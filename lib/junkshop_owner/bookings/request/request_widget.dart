    ...
    return Align(
      ...
      child: StreamBuilder<JunkshopAppointmentsRecord>(
        stream: JunkshopAppointmentsRecord.getDocument(widget.appointmentRef!)
          ..listen((containerJunkshopAppointmentsRecord) async {
            if (_model.containerPreviousSnapshot != null &&
                !JunkshopAppointmentsRecordDocumentEquality().equals(
                    containerJunkshopAppointmentsRecord,
                    _model.containerPreviousSnapshot)) {
              if (containerJunkshopAppointmentsRecord.status != 'Requested') {
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  '${containerUserRecord.houseNoStreet} ${containerUserRecord.barangay}, Baliwag, Bulacan',
                                                  style: FlutterFlowTheme.of(
                                                          context)
                                                      .bodyMedium
                                                      .override(
                                          ...
                                          children: [
                                            ...
                                            Column(
                                              ...
                                              crossAxisAlignment:
                                                  CrossAxisAlignment.start,
                                              children: [
                                                if (containerJunkshopAppointmentsRecord
                                                        .hasPlasticJunks() ==
                                                    true)
                                                  Row(
                                                    mainAxisSize:
                                  ...
                                  children: [
                                        ...
                                        return FlutterFlowDropDown<String>(
                                          ...
                                          options: List<String>.from(
                                              dropDownStaffRecordList
                                                  .map((e) => e.staffUserID)
                                                  .toList()),
                                          optionLabels: dropDownStaffRecordList
                                              .map((e) => e.fullName)
                                              .toList(),
                                          onChanged: (val) async {
                                            safeSetState(() =>
                                    ...
                                    Padding(
                                      padding: EdgeInsetsDirectional.fromSTEB(
                                          0.0, 0.0, 0.0, 15.0),
                                      child: Text(
                                        'Note: Not choosing a staff will automatically set you as the appointed personnel for this appointment',
                                    ...
                                    onPressed: () async {
                                      if (_model.textController.text != '') {
                                        var confirmDialogResponse =
                                            await showDialog<bool>(
                                                  ...
                                                  builder:
                                                    ...
                                                    return AlertDialog(
                                                      content: Text(
                                                          'Service Charge: Php ${_model.textController.text}'),
                                                      actions: [
                                                        TextButton(
                                                          onPressed: () =>
                                                              Navigator.pop(
                                        ...
                                        if (confirmDialogResponse) {
                                          await containerJunkshopAppointmentsRecord
                                              .reference
                                              .update({
                                          ...
                                          await NotificationRecord.collection
                                            ...
                                            ...createNotificationRecordData(
                                              ...
                                              message:
                                                  '${containerJunkshopAppointmentsRecord.junkshopName} accepted your booking.',
                                              receiver:
                                                  containerJunkshopAppointmentsRecord
                                                      .bookerRef,
                                            ),
                                            ...
                                            await NotificationRecord.collection
                                              ...
                                              ...createNotificationRecordData(
                                                image:
                                                    'https://firebasestorage.googleapis.com/v0/b/ecommunity-awspik.appspot.com/o/junkshop.png?alt=media&token=75a3b503-13d1-4371-ad84-1b37117de0e9',
                                                message:
                                                    '${containerJunkshopAppointmentsRecord.junkshopName} assigned you a task.',
                                                receiver: functions
                                                    .covertStringToDocRef(
                                                        _model.dropDownValue),
                                                userTypeOfReceiver:
