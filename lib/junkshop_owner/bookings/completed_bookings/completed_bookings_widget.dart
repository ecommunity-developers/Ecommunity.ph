...
import 'completed_bookings_model.dart';
export 'completed_bookings_model.dart';

class CompletedBookingsWidget extends StatefulWidget {
  const CompletedBookingsWidget({super.key});

  static String routeName = 'completedBookings';
  static String routePath = '/completedBookings';

  @override
  State<CompletedBookingsWidget> createState() =>
      _CompletedBookingsWidgetState();
}

class _CompletedBookingsWidgetState extends State<CompletedBookingsWidget>
    with TickerProviderStateMixin {
  late CompletedBookingsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CompletedBookingsModel());
    ...
    return StreamBuilder<List<JunkshopAppointmentsRecord>>(
      ...
      builder: (context, snapshot) {
        ...
        List<JunkshopAppointmentsRecord>
            completedBookingsJunkshopAppointmentsRecordList = snapshot.data!;
                                        ...
                                        () async {
                                          safeSetState(() {
                                            _model.simpleSearchResults =
                                                TextSearch(
                                              completedBookingsJunkshopAppointmentsRecordList
                                                  .map(
                                                                      ...
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              'Completed on ${dateTimeFormat("yMd", searchAppoinmentsItem.paymentTime)} ${dateTimeFormat("jm", searchAppoinmentsItem.paymentTime)}',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.karla(
                                                                      ...
                                                                      Flexible(
                                                                        child:
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            Text(
                                                                              'Completed on ${dateTimeFormat("yMd", allAppoinmentsItem.paymentTime)} ${dateTimeFormat("jm", allAppoinmentsItem.paymentTime)}',
                                                                              style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                    font: GoogleFonts.karla(
                                                                                      fontWeight: FontWeight.normal,
                                                                                      fontStyle: FontStyle.italic,
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 10.0, 20.0, 20.0),
                              child: Text(
                                '${_model.isSearching == true ? _model.simpleSearchResults.length.toString() : completedBookingsJunkshopAppointmentsRecordList.length.toString()} Completed Appoinments',
