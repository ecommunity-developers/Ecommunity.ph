...
import 'reject_prompt_model.dart';
export 'reject_prompt_model.dart';

class RejectPromptWidget extends StatefulWidget {
  const RejectPromptWidget({
    super.key,
    required this.appointmentRef,
    required this.junkshopName,
    required this.bookerRef,
  });

  final DocumentReference? appointmentRef;
  final String? junkshopName;
  final DocumentReference? bookerRef;

  @override
  State<RejectPromptWidget> createState() => _RejectPromptWidgetState();
}

class _RejectPromptWidgetState extends State<RejectPromptWidget>
    with TickerProviderStateMixin {
  late RejectPromptModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RejectPromptModel());
                                  ...
                                  if (_model.textController.text != '') {
                                    ...
                                    await NotificationRecord.collection
                                      ...
                                      ...createNotificationRecordData(
                                        ...
                                        message:
                                            '${widget.junkshopName} declined you booking.',
                                        receiver: widget.bookerRef,
                                      ),
                                      ...mapToFirestore(
                                        {
                                          'created_time':
                                    ...
                                    await showDialog(
                                      ...
                                      builder: (alertDialogContext) {
                                        return AlertDialog(
                                          content: Text('Remarks is required.'),
                                          actions: [
                                            TextButton(
