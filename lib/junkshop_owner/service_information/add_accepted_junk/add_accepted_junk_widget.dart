...
import 'add_accepted_junk_model.dart';
export 'add_accepted_junk_model.dart';

class AddAcceptedJunkWidget extends StatefulWidget {
  const AddAcceptedJunkWidget({super.key});

  @override
  State<AddAcceptedJunkWidget> createState() => _AddAcceptedJunkWidgetState();
}

class _AddAcceptedJunkWidgetState extends State<AddAcceptedJunkWidget>
    with TickerProviderStateMixin {
  late AddAcceptedJunkModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AddAcceptedJunkModel());

    _model.instructionsTextController1 ??= TextEditingController();
    _model.instructionsFocusNode1 ??= FocusNode();

    _model.priceTextController ??= TextEditingController();
    _model.priceFocusNode ??= FocusNode();

    _model.pricigRemarksTextController ??= TextEditingController();
    _model.pricigRemarksFocusNode ??= FocusNode();

    _model.instructionsTextController2 ??= TextEditingController();
                                          ...
                                          var confirmDialogResponse =
                                              await showDialog<bool>(
                                                    ...
                                                    builder:
                                                      ...
                                                      return AlertDialog(
                                                        content: Text(
                                                            'Are you sure you want to add this to the list of accepted junks/kalakal?'),
                                                        actions: [
                                                          TextButton(
                                                            onPressed: () =>
                                                                Navigator.pop(
                                                  ...
                                                  false;
                                          if (confirmDialogResponse) {
                                            await ServiceInformationRecord
                                                    .createDoc(
                                                        card8JunkshopRecord!
                                                            .reference)
                                                .set({
