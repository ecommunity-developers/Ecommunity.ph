...
import 'post_announcement_model.dart';
export 'post_announcement_model.dart';

class PostAnnouncementWidget extends StatefulWidget {
  const PostAnnouncementWidget({super.key});
...
class _PostAnnouncementWidgetState extends State<PostAnnouncementWidget>
  ...
  late PostAnnouncementModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PostAnnouncementModel());
      ...
      child: StreamBuilder<List<GarbageCollectionDateRecord>>(
        ...
        builder: (context, snapshot) {
          ...
          List<GarbageCollectionDateRecord>
              card8GarbageCollectionDateRecordList = snapshot.data!;
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    FlutterFlowDropDown<String>(
                      ...
                      options: card8GarbageCollectionDateRecordList
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: 'Enter your announcement/s here...',
                          hintStyle:
                              FlutterFlowTheme.of(context).labelMedium.override(
                                    font: GoogleFonts.karla(
                                      fontWeight: FlutterFlowTheme.of(context)
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  if ((((_model.dropDownValue != null &&
                                    ...
                                    await BrgyAnnouncementsRecord.collection
                                        .doc()
                                        .set({
                                      ...
                                      ...mapToFirestore(
                                        {
                                          ...
                                          'addresses': _model.checkboxValue ==
                                                  true
                                              ? card8GarbageCollectionDateRecordList
                                                  .map((e) => e.barangay)
                                                  .toList()
                                              : _model.dropDownValue,
                                        },
